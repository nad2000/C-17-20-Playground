...
complex.a: complex.o
	llvm-ar rc complex.a complex.o

.complex_test: complex.a complex_test.cpp
	$(CLANG) -pthread complex_test.cpp complex.a -o .complex_test $(LIB)

complex_test: .complex_test
	./.complex_test


complex_testN: .complex_test
	./.complex_test --gtest_repeat=1000 --gtest_shuffle

complexCoverage: complex_testN
	lcov --directory . \
	       --base-directory . \
